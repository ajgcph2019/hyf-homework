...
class SpamDetector {
    ...
    isSpam(email) {
        ...
        const checkUpperCaseWords = (email) => {
        ...
        const result = [checkUpperCaseWords(email), checkSpamWords(email), checkSubjectContainsHello(email)];
        return result.some(r => r); 
        
    }
}

const emailFromOldFriend = new Email('Viagra', 'project completed');
